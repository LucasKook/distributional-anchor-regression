...
for (scenario in 1:nrow(setup)) {
  ...
  csv_write(ll_anchor, paste0("results/iv2/ll_anchor", "_", fn))
  csv_write(ll_plain, paste0("results/iv2/ll_plain", "_", fn))
  csv_write(cfx_anchor, paste0("results/iv2/cfx_anchor", "_", fn))
  csv_write(cfx_plain, paste0("results/iv2/cfx_plain", "_", fn))
